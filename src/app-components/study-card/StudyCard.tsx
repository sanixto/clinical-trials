...
export default function StudyCard({
  ...
  return (
    <div className="border-2 rounded-xl p-10 text-xl border-green-200 bg-white">
      <div className="flex flex-col gap-5 h-full">
        ...
        <div className="flex justify-between mt-auto">
          <Link href={`${routeNames.studies}/${code}`} variant="primary">
            Learn More
          </Link>
          <Link href={`${routeNames.apply}/${code}`} variant="outline">
            Apply To Trial
          </Link>
        </div>
      </div>
