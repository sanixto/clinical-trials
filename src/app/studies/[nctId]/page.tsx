...
export default async function StudyPage({ params }: StudyPageProps) {
  ...
  return (
    <main className="p-5 lg:p-10 bg-green-50 rounded-xl">
      <div className="border-2 flex flex-col gap-5 lg:gap-10 rounded-xl p-5 lg:p-10 text-lg lg:text-xl border-green-200 bg-white">
        <div className="flex flex-col gap-5 h-full">
          <header>
            <span className="rot text-green-600 rounded-xl bg-green-50 p-2 lg:p-3 text-base lg:text-lg float-right font-bold">
